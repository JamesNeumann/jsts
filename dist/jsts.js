...
(function (global, factory) {
  ...
  for (const type in GeometryType) GeometryType[type].toUpperCase();
  /**
    ...
    static getStackTrace() {
      if (arguments.length === 1) {
        ...
        const t = arguments[0],
              depth = arguments[1];
        let stackTrace = '';
        new StringReader(StringUtil.getStackTrace(t));
        const lineNumberReader = new LineNumberReader();
